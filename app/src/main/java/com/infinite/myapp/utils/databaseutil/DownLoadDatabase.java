package com.infinite.myapp.utils.databaseutil;
...
public class DownLoadDatabase {
    ...
    public static final class DownLoad {
         ...
         * 表名
         */
        public static final String TABLE_NAME = "my_download";
     ...
     * 更新一条历史查询记录
     */
    public synchronized void update(DownLoadModel entity) {
    ...
    public synchronized DownLoadModel querySingle(String url, String start) {
        SQLiteDatabase sqlite = dbHelper.getWritableDatabase();
        DownLoadModel entity = null;
    ...
    public synchronized void deleteAllByUrl(String url) {
        ArrayList<DownLoadModel> list = query(url);
        if (list.size() > 0) {
            Iterator iterator = list.iterator();
            while (iterator.hasNext()) {
                DownLoadModel entity = (DownLoadModel) iterator.next();
     ...
     * @return
     */
    public synchronized ArrayList<DownLoadModel> query(String url) {
        ...
        ArrayList<DownLoadModel> data = new ArrayList<>();
