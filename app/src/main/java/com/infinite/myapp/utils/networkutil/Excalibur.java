...
public class Excalibur {
    ...
    public void init(Context context, String baseUrl) {
        MyNetWorkRequest.getInstance().init(context, baseUrl);
    }
    ...
    public void cancelNetWork(String tag) {
        MyNetWorkRequest.getInstance().removeTagCall(tag);
    }

    public void cancelNetWork(String tag, int requestCode) {
        MyNetWorkRequest.getInstance().removeCall(tag, requestCode);
    }
}
